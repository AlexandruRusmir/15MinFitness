...
public class DumbbellDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dumbbell_detail);

        backButton = findViewById(R.id.back_button4);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DumbbellDetailActivity.this, DumbbellActivity.class);
    ...
    private void getSelectedExercise() {
        ...
        selectedExercise = DumbbellActivity.exercises.get(Integer.valueOf(parsedStringID));
    }
