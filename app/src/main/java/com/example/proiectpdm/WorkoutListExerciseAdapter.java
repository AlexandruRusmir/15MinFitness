...
public class WorkoutListExerciseAdapter extends ArrayAdapter<Exercise> {
    public WorkoutListExerciseAdapter(Context context, int resource, List<Exercise> exerciseList) {
