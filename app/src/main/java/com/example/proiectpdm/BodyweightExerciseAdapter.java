...
public class BodyweightExerciseAdapter extends ArrayAdapter<Exercise> {

    public BodyweightExerciseAdapter(Context context, int resource, List<Exercise> exerciseList) {
